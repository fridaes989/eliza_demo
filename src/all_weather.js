...
const portfolioConfig = {
    ...
    portfolio: {
        ...
        description: "<p class='pb-4'>全天候策略 (All-Weather Strategy) 是一個由全球最大避險基金「橋水基金」的創辦人瑞·達利歐(Ray Dalio)所創造的著名投資組合策略。</p><p>其核心理念非常簡單卻強大：不要試圖去預測未來的經濟走向，而是建立一個在任何經濟環境下（無論晴天或雨天）都能有相對穩健表現的投資組合。</p>",        
        pros: [
